...
function Nominatedposition() {
  ...
  const handlePositionChange = (event) => {
    ...
    axios.get(`https://virtual.chevroncemcs.com/voting/nominations/position/${selectedPositionId}`, {
      headers: {
  ...
  return (
    <div>
      ...
      <div className="container mx-auto mt-20">
        <h1 className='text-center font-bold text-3xl mb-6'>Nominations By Position</h1>
        <div className="mb-4">
...
export default Nominatedposition;
