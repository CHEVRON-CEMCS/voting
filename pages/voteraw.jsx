    ...
    return (
        <div>
            ...
            <div className="container mx-auto mt-20">
                <h1 className="text-3xl font-bold text-center mb-4">Raw Voting Data</h1>
                ...
                <div className="mb-2 mt-2 text-lg font-semibold">Total Votes: {nominations.length}</div>
